...
class CNN(object):
    ...
    def __init__(self, input_width, num_input_channels, num_channels, kernel_sizes, strides,
        ...
        self.linear_layer.W = linear_weight_init_fn(self.linear_layer.W.shape[0], self.linear_layer.W.shape[1])
        self.linear_layer.b = bias_init_fn(self.linear_layer.b.shape[0]).reshape(-1, 1)
