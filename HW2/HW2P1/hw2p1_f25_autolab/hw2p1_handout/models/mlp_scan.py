...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = w1.T
        self.conv1.conv1d_stride1.W = self.conv1.conv1d_stride1.W.reshape(self.conv1.conv1d_stride1.out_channels, self.conv1.conv1d_stride1.kernel_size, self.conv1.conv1d_stride1.in_channels)
        self.conv1.conv1d_stride1.W = self.conv1.conv1d_stride1.W.transpose(0, 2, 1)
        self.conv2.conv1d_stride1.W = w2.T
        self.conv2.conv1d_stride1.W = self.conv2.conv1d_stride1.W.reshape(self.conv2.conv1d_stride1.out_channels, self.conv2.conv1d_stride1.kernel_size, self.conv2.conv1d_stride1.in_channels)
        self.conv2.conv1d_stride1.W = self.conv2.conv1d_stride1.W.transpose(0, 2, 1)
        self.conv3.conv1d_stride1.W = w3.T
        self.conv3.conv1d_stride1.W = self.conv3.conv1d_stride1.W.reshape(self.conv3.conv1d_stride1.out_channels, self.conv3.conv1d_stride1.kernel_size, self.conv3.conv1d_stride1.in_channels)
...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = weights[0][:48,:2]
        self.conv1.conv1d_stride1.W = self.conv1.conv1d_stride1.W.T
        self.conv1.conv1d_stride1.W = self.conv1.conv1d_stride1.W.reshape(self.conv1.conv1d_stride1.out_channels, self.conv1.conv1d_stride1.kernel_size, self.conv1.conv1d_stride1.in_channels)
        self.conv1.conv1d_stride1.W = self.conv1.conv1d_stride1.W.transpose(0, 2, 1)
        
        self.conv2.conv1d_stride1.W = weights[1][:4,:8]
        self.conv2.conv1d_stride1.W = self.conv2.conv1d_stride1.W.T
        self.conv2.conv1d_stride1.W = self.conv2.conv1d_stride1.W.reshape(self.conv2.conv1d_stride1.out_channels, self.conv2.conv1d_stride1.kernel_size, self.conv2.conv1d_stride1.in_channels)
        self.conv2.conv1d_stride1.W = self.conv2.conv1d_stride1.W.transpose(0, 2, 1)
    
        self.conv3.conv1d_stride1.W = weights[2]
        self.conv3.conv1d_stride1.W = self.conv3.conv1d_stride1.W.T
        self.conv3.conv1d_stride1.W = self.conv3.conv1d_stride1.W.reshape(self.conv3.conv1d_stride1.out_channels, self.conv3.conv1d_stride1.kernel_size, self.conv3.conv1d_stride1.in_channels)
        self.conv3.conv1d_stride1.W = self.conv3.conv1d_stride1.W.transpose(0, 2, 1)
