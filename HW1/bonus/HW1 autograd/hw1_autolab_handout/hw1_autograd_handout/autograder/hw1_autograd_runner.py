...
test_list = {
    'autograd': [
        ...
        },
        {
            ...
            'handler': lambda: (test_backward() and test_backward_gradient_update()),
            'value': 5,
        }
    ],
    'operations': [
    ...
    'linear': [
        {
            ...
            'handler': lambda: (test_linear_layer_forward() and test_linear_layer_forward_different_sizes() and test_linear_bias_broadcasting() and test_linear_edge_cases() and test_linear_with_non_linearity()),
            'value': 2,
        },
        {
    ...
    'activation': [
        ...
        },
        {
            ...
            'handler': lambda: (test_sigmoid_backward() and test_sigmoid_negative_zero_positive()),
            'value': 4,
        },
        {
        ...
        },
        {
            ...
            'handler': lambda: (test_tanh_backward() and test_tanh_negative_zero_positive()),
            'value': 4,
        },
        {
        ...
        },
        {
            ...
            'handler': lambda: (test_relu_backward() and test_relu_negative_zero_positive()),
            'value': 4,
        }
    ],
    'loss': [
        {
            ...
            'handler': lambda: (test_softmaxXentropy_forward() and test_softmaxXentropy_forward_batch() and test_softmaxXentropy_forward_edge_cases() and test_softmaxXentropy_forward_batch_size_one()),
            'value': 1,
        },
        {
            'name': '4.3.3.2 - SoftmaxCrossEntropy Loss (Autograd) Backward',
            'autolab': 'SoftmaxCrossEntropy Loss (Autograd) Backward',
            'handler': lambda: (test_softmaxXentropy_backward() and test_softmaxXentropy_backward_gradient_magnitude()),
            'value': 4,
        },
    ],
}
