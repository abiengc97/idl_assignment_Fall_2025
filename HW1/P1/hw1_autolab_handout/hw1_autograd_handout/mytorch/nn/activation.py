...
class Activation(object):
    """
    Interface for activation functions (non-linearity).
    In all implementations, the state attribute must contain the result, i.e. the output of forward (it will be tested).
    """

    # No additional work is needed for this class, as it acts like an abstract base class for the others

    # Note that these activation functions are scalar operations. i.e, they shouldn't change the shape of the input.
...
class Sigmoid(Activation):
    ...
    Feel free to refer back to your implementation from part 1 of the HW1 for equations.
    """
