...
class Linear():
    ...
    def forward(self, x):
        ...
        """
        # TODO: Use the primitive operations to calculate the affine transformation of the linear layer.
        ...
        # Note: Remember you need to pass the same op and dims you are using for the calculation to backward op using add_operation().
        # Note: How can you prevent constant value update in gradient calculation? Read more about the 'None' parameter.
